...
public class BlindnessStatus : Debuff
{
    ...
    public BlindnessStatus(int durationInTurns)
    {
    ...
    {
        if (active && modifierType == DerivedStatModifierType.SightDistance)
        {
            return -2;
        }
        return 0;
    ...
    {
        if (active && modifierType == RollModifierType.Perception)
        {
            return -2;
        }
        return 0;
